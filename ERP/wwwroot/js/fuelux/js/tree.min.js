    ...
    e.prototype = {
        ...
        selectItem: function (e) {
            var i = t(e),
                ...
                j = this.$element.find(".folderselected"),
                r = [];
            ...
            j.removeClass("folderselected"); r.push(i.data()); this.options.selectable;
        ...
        selectFolder: function (e) {
            ...
            if (this.options.multiSelect ? t.each(n, function (e, n) {
                ...
                var o = "selected";
                //i.hasClass("tree-selected") ? (o = "unselected", i.removeClass("tree-selected")) : (i.addClass("tree-selected"), this.options.multiSelect && r.push(i.data()))
                j.removeClass("folderselected"); r.push(i.data()); this.options.selectable;
                i.addClass("folderselected"), this.options.multiSelect && r.push(i.data());
            }
            r.length && this.$element.trigger("selected", {
                info: r
            }), i.trigger("updated", {
