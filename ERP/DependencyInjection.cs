...
namespace ERP.DependencyInjection
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services)
        {
            ...
            services.AddScoped<ICountryRepository, SQLCompanyRepository>();
            ...
            services.AddScoped<ICityService, CountryService>();
            services.AddScoped<ILocationService, ParentService>();
            services.AddScoped<IBranchService, CityService>();
